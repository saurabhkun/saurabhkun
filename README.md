...
const saurabh: Developer = {
  ...
  secret     : "Blender + AE visuals meet backend code ⚡🎬",
  funFact    : "I build from circuits to cloud — literally.",
};
```
...
![Snake animation](https://raw.githubusercontent.com/saurabhkun/saurabhkun/output/github-contribution-grid-snake-dark.svg)
